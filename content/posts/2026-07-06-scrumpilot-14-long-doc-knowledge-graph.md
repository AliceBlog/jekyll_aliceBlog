---
title: "ScrumPilot 14：长文档 + 知识图谱"
subtitle: "从 chunk 搜索升级到结构理解和关系检索。"
date: 2026-07-06T10:14:00+08:00
url: "/2026/07/06/scrumpilot-14-long-doc-knowledge-graph.html"
categories: ["技术"]
tags: ["ScrumPilot", "AI Scrum Master", "Agent工程", "敏捷开发", "从0到1", "知识图谱"]
weight: 0
---

Sprint 12 面向长 PRD 和复杂架构文档。仅靠 chunk 搜索很难回答“哪些需求受这个风险影响”这类问题，所以需要长文档分析和项目知识图谱。

## 本篇要解决的问题

这一篇关注 `知识图谱`。如果把 ScrumPilot 看成一个从 0 到 1 的 AI 工程项目，这一步的价值不是单点功能，而是让上一阶段的能力能够继续向后演进。

## 交付目标

- 章节结构分析
- 需求/风险/决策抽取
- Project/Sprint/Story/Risk 节点
- 图谱检索
- 复杂问答上下文
...
图谱不替代 RAG，而是增强 RAG。搜索能找到相关片段，图谱能说明片段之间的关系。
...
知识图谱 是 ScrumPilot 逐步产品化的一块拼图。每一块单独看都不夸张，但组合起来，就能把一个 AI Scrum Master 从 Demo 推到可运行、可观测、可交付的系统。
