---
title: "ScrumPilot 18：文档 / 演示 / 培训"
subtitle: "把系统能力转成用户能理解、团队能学习、客户能演示的交付包。"
date: 2026-07-06T10:18:00+08:00
url: "/2026/07/06/scrumpilot-18-docs-demo-training.html"
categories: ["技术"]
tags: ["ScrumPilot", "AI Scrum Master", "Agent工程", "敏捷开发", "从0到1", "发布文档"]
weight: 0
---

Sprint 16 不再扩展核心功能，而是整理用户手册、演示指南、培训计划和发布检查。很多项目不是死在功能不够，而是死在没人会用。

## 本篇要解决的问题

这一篇关注 `发布文档`。如果把 ScrumPilot 看成一个从 0 到 1 的 AI 工程项目，这一步的价值不是单点功能，而是让上一阶段的能力能够继续向后演进。
...
文档不是附属品，而是产品的一部分。尤其是 AI 工具，用户需要知道能做什么、不能做什么、失败时怎么看。
...
发布文档 是 ScrumPilot 逐步产品化的一块拼图。每一块单独看都不夸张，但组合起来，就能把一个 AI Scrum Master 从 Demo 推到可运行、可观测、可交付的系统。
