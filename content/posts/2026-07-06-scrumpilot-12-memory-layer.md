---
title: "ScrumPilot 12：Memory 分层体系"
subtitle: "让系统记住项目事实、用户偏好和迭代经验。"
date: 2026-07-06T10:12:00+08:00
url: "/2026/07/06/scrumpilot-12-memory-layer.html"
categories: ["技术"]
tags: ["ScrumPilot", "AI Scrum Master", "Agent工程", "敏捷开发", "从0到1", "Memory"]
weight: 0
---

RAG 偏向知识检索，Memory 偏向经验沉淀。Sprint 10 建立短期、工作、长期、知识四层记忆，让 ScrumPilot 不只是一次性执行工具。

## 本篇要解决的问题

这一篇关注 `Memory`。如果把 ScrumPilot 看成一个从 0 到 1 的 AI 工程项目，这一步的价值不是单点功能，而是让上一阶段的能力能够继续向后演进。
...
例如一次风险扫描发现“测试资源长期瓶颈”，这不只是日报内容，也应该提升为长期记忆，在下次 Planning 时提醒容量风险。
...
Memory 是 ScrumPilot 逐步产品化的一块拼图。每一块单独看都不夸张，但组合起来，就能把一个 AI Scrum Master 从 Demo 推到可运行、可观测、可交付的系统。
